...
public class Asthetic {
 ...
 //for each of the following do one iteration of thoes which have some work to do   
    public void hand(Asthetic specificType)
    {
        this.hand=specificType;
    }
    ...
    public void handHumunculous(Asthetic specificType)
    {
        this.handHumunculous=specificType;
    }
    ...
    public void eye(Asthetic specificType)
    {
        this.eye=specificType;
    }
    ...
    public void eyeHumunculous(Asthetic specificType)
    {
        this.eyeHumunculous=specificType;
    }
    //Critique:
